...
void Menu::Draw(sf::RenderWindow& window, sf::Vector2f position,
                sf::Vector2f origin) {
    ...
    DrawTextList(window, texts, expandedItem.childrenSpacing,
...
void Menu::SwitchToPreviousMenuItem() {
    ...
    auto it = std::find_if(
        parent->childrens.begin(), parent->childrens.end(),
